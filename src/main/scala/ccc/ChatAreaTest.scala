...
class ChatAreaTest extends BaseApplication {
  ...
  val panda = new Image("https://cdn.discordapp.com/avatars/84766711735136256/28063abbe16697aa29d99d004ebd177f.png?size=256", 50, 50, true, true)
  val totoro = new Image("https://cdn.discordapp.com/avatars/183411122848661505/81e6a9370e6a54ea19b3acad6c811e61.png?size=256", 50, 50, true, true)
  for (i <- 0 until 100) {
